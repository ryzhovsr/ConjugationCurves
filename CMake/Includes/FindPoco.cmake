...
if(WIN32)
    if(EXISTS "//lib/DevArchive/RPLM/Poco/Foundation/include/Poco/Foundation.h")
		set(Poco_ROOT_DIR "//lib/DevArchive/RPLM/poco")
	else()
		set(Poco_ROOT_DIR "C:/poco")
	endif()
else()
  set(Poco_ROOT_DIR "/usr/src/poco/")
endif()
...
foreach( component ${components} )
    ...
    if(NOT Poco_${component}_INCLUDE_DIR)
		...
		elseif (${component} STREQUAL "DataPostgreSQL")
            set (component_top "Data")
            set (component_in "PostgreSQL")
            set (component_root "Data/PostgreSQL")
        elseif (${component} STREQUAL "SQLODBC")
            set (component_top "SQL")
            set (component_in "ODBC")
            set (component_root "SQL/ODBC")
		elseif (${component} STREQUAL "SQLPostgreSQL")
			set (component_top "SQL")
			set (component_in "PostgreSQL")
			set (component_root "SQL/PostgreSQL")
        elseif (${component} STREQUAL "NetSSL")
            set (component_alt "Net")
            set (component_root "NetSSL_OpenSSL")
			set (component_in "openssl")
		elseif (${component} STREQUAL "WinTestRunner")
			set (component_top "CppUnit")
			set (component_in "WinTestRunner")
			set (component_root "CppUnit/WinTestRunner")
		elseif (${component} STREQUAL "openssl")
			set (component_top "CppUnit")
			set (component_in "WinTestRunner")
			set (component_root "openssl")		
		else ()
        ...
        find_path(Poco_${component}_INCLUDE_DIR
            NAMES
				...
				Poco/${component_top}/${component_in}/include/${component_in}.h
            HINTS
                ${Poco_ROOT_DIR}
            PATH_SUFFIXES
                include
				...
				${component_root}/build/include
				${component_root}/include/${component_in}
				${component_top}/${component_in}/include
        )
